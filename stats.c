...
/**
 * @file stat.c
 * @brief Statistical analysis to data set.
 *
 ...
 * from large to small and rounded down to the nearest integer. 
 *
...
void main() {
  ...
  /* Statistics and Printing Functions Go Here */
       ...
       printf("<<< Introduction to Embedded Systems Software Assignment Week1 >>>\n");
